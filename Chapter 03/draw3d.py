...
def draw3d(*objects, origin=True, axes=True, save_as=None, azim=None, elev=None,
           xlim=None, ylim=None, zlim=None, xticks=None, yticks=None, zticks=None, depthshade=False):
